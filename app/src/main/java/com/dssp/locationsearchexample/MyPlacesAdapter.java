...
/**
 * Created by dhanrajnaik522 on 2/9/2016.
 */
...
/**
 * Note that this adapter requires a valid {@link GoogleApiClient}. The API client must be
 * maintained in the encapsulating Activity, including all lifecycle and connection states. The API
 * client must be connected with the {@link Places#GEO_DATA_API} API.
 */
public class MyPlacesAdapter
        extends RecyclerView.Adapter<MyPlacesAdapter.PredictionHolder> implements Filterable {
    ...
    public MyPlacesAdapter(Context context, int resource, GoogleApiClient googleApiClient,
